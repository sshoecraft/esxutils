...
static int put_req(struct soap *soap, void *arg) {
	...
	return soap_send_desc(soap,"PowerOffVM_Task","xmlns",MYNS,put_req_desc);
}
...
static int get_resp(struct soap *soap, void *arg) {
	...
	return soap_recv_desc(soap, "PowerOffVM_TaskResponse", get_resp_desc);
}

SOAPFUNCIO(PowerOffVM,put_req,struct ManagedObjectReference *,get_resp,struct ManagedObjectReference **);
